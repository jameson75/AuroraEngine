...
float3x3 WorldIXf : WorldInverse;
...
float Stride = 1.0f; //Texel Stride

static float TexelIncrement = (Stride/RTT_SIZE);

//[FORMAT=X8R8G8B8, DIMENSIONS={RTTSIZE, RTT_SIZE}, MIPLEVELS=1]
...
//[FORMAT=D24S8, DIMENSIONS={RTTSIZE, RTT_SIZE}]
